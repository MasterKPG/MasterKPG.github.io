...
/* Media assets
   ...
   build never breaks on a missing file and media can be dropped in anytime:

     public/assets/covers/<id>.webp   cover image
...
export const PROJECTS: Project[] = [
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#0c2530 60%,#0891b2)',
    featured: true,
    title: { en: 'Arduino Clone: Board to Game', fr: 'Clone Arduino : de la carte au jeu' },
    blurb: {
      en: 'An ATmega328P board built by hand: schematic, routing, soldering and bootloader.',
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#0e2229 60%,#06b6d4)',
    ...
    description: {
      en: 'A classic Pong rendered on a display and driven by buttons on the board I built. Fixed timestep refresh loop, paddle and ball collision detection and score tracking, written in C/C++ for the ATmega.',
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#101f2c 55%,#22d3ee)',
    ...
    description: {
      ...
      fr: "Un additionneur binaire décrit en VHDL : logique combinatoire, propagation de la retenue et banc de test à vérification automatique. Simulé et synthétisé dans le cadre du travail de logique numérique derrière la carte maison.",
    },
    categories: ['hardware', 'embedded'],
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#0c2620 60%,#14b8a6)',
    ...
    description: {
      en: 'An IoT plant monitoring system: soil moisture, temperature and light sensors feed a microcontroller that triggers automatic watering above threshold and reports readings. Built end to end, from sensor wiring to firmware.',
      fr: "Un système de surveillance de plante IoT : des capteurs d'humidité du sol, de température et de luminosité alimentent un microcontrôleur qui déclenche l'arrosage automatique lorsqu'un seuil est franchi et remonte les mesures. Réalisation de bout en bout, du câblage des capteurs au firmware.",
    },
    categories: ['hardware', 'embedded'],
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#0e1d2c 60%,#38bdf8)',
    title: { en: 'TIPE: Sailboat Dynamics', fr: 'TIPE : dynamique des voiliers' },
    blurb: {
      en: 'Physical modelling of sailboat performance with Dijkstra on a weighted graph.',
      fr: 'Modélisation physique des performances et Dijkstra sur graphe pondéré.',
    },
    description: {
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#131c26 55%,#67e8f9)',
    ...
    description: {
      en: 'Implementations of KNN and K-Means written from scratch with matrix computation (NumPy/SciPy) and Matplotlib visualisations to analyse the resulting clusters.',
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#0e1c26 60%,#2dd4bf)',
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#141a24 60%,#0ea5e9)',
    title: { en: 'C++ DLL Injection', fr: 'Injection DLL en C++' },
    blurb: {
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#181a1e,#101a20 55%,#0891b2)',
...
/** Words cycled through in the hero tag: the technologies I work with. */
export const MORPH_WORDS: Bi[] = [
  { en: 'VHDL', fr: 'VHDL' },
  { en: 'Embedded', fr: 'Embarqué' },
  { en: 'PCB Design', fr: 'Conception PCB' },
  { en: 'Arduino', fr: 'Arduino' },
  { en: 'C / C++', fr: 'C / C++' },
  { en: 'Python', fr: 'Python' },
  { en: 'Electronics', fr: 'Électronique' },
  { en: 'Systems', fr: 'Systèmes' },
]
...
export const EDUCATION: TimelineEntry[] = [
  {
    date: { en: 'Sept. 2024 to Present', fr: "Sept. 2024 à aujourd'hui" },
    title: { en: 'Systems Engineering & Embedded', fr: 'Ingénierie des systèmes & embarqué' },
    place: {
      en: 'ENSSAT, University of Rennes · Lannion, France',
      fr: 'ENSSAT, Université de Rennes · Lannion, France',
    },
    desc: {
  ...
  {
    date: { en: 'Sept. 2022 to Jul. 2024', fr: 'Sept. 2022 à juil. 2024' },
  ...
  {
    date: { en: 'Sept. 2021 to Jul. 2022', fr: 'Sept. 2021 à juil. 2022' },
    title: {
      en: 'Scientific Baccalaureate, Highest Honours',
      fr: 'Baccalauréat Scientifique, Mention Très Bien',
    },
...
export const EXPERIENCE: TimelineEntry[] = [
  {
    date: { en: '2025 to Present', fr: "2025 à aujourd'hui" },
  ...
  {
    date: { en: '2019 to 2021', fr: '2019 à 2021' },
...
export const COPY = {
  ...
  skills: {
    ...
    sub: {
      en: 'A hardware and software range, from the transistor to the program.',
      fr: 'Un éventail hardware et software, du transistor au programme.',
    },
  },
  experience: {
...
export const CONTACT = {
  ...
  languages: { en: 'Arabic, French, English', fr: 'Arabe, Français, Anglais' } as Bi,
}
